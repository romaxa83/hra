...
type OrderServiceClient interface {
	// Создает новый заказ
	CreateTest(ctx context.Context, in *CreateTestRequest, opts ...grpc.CallOption) (*TestResponse, error)
	// Создает новый заказ
...
func (c *orderServiceClient) CreateTest(ctx context.Context, in *CreateTestRequest, opts ...grpc.CallOption) (*TestResponse, error) {
	out := new(TestResponse)
	err := c.cc.Invoke(ctx, "/orders.OrderService/CreateTest", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type OrderServiceServer interface {
	// Создает новый заказ
	CreateTest(context.Context, *CreateTestRequest) (*TestResponse, error)
	// Создает новый заказ
...
func (UnimplementedOrderServiceServer) CreateTest(context.Context, *CreateTestRequest) (*TestResponse, error) {
...
func _OrderService_CreateTest_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreateTestRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(OrderServiceServer).CreateTest(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/orders.OrderService/CreateTest",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServiceServer).CreateTest(ctx, req.(*CreateTestRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _OrderService_CreateTest_Handler,
		},
		{
			MethodName: "Create",
